...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    /*State Variable */
    uint16 private constant REQUEST_CONFIRMATIONS = 3; // Number of confirmations required to consider the request fulfilled
    ...
    constructor(
        ...
        /* Can also do s_raffleState = RaffleState(0); */
    }
     ...
     * The following should be true in order for the upkeep needed to be true:
